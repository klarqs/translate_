...
import 'package:polyglot/models/language.dart';
import 'package:polyglot/components/languageListElements.dart';
...
class _LanguagePageState extends State<LanguagePage> {
  ...
  Widget _displayListWithHeaders() {
    List recentLanguages = this._languageList.where((e) => e.isRecent).toList();
